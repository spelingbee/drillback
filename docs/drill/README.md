...
| [gotify](gotify/) | 15,815 | [configuration reference](https://gotify.net/docs/config) | 3.1.0 | **PASS** / **PARTIAL** | No backup page, but the installation page says to include /app/data in your backups (the drill missed that sentence; corrected 2026-09-04). The data directory restores everything; gotify.db on its own restores the accounts, applications, tokens and messages, and leaves every uploaded application icon behind as a broken image. |
